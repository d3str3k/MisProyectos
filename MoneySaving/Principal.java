...
public class Principal extends JFrame implements ActionListener{
    ...
    comboDepartamento.addItem("Departamento de LogÃ­stica");
    ...
    comboAntiguedad.addItem("2 a 6 aÃ±os de servicio");
    comboAntiguedad.addItem("7 aÃ±os o más de servicio");

    labelResultado = new JLabel("Resultado del CÃ¡lculo:");
    ...
    textarea1.setText("\n   Aquí aparece el resultado del cÃ¡lculo de las vacaciones.");
